...
abstract class AppLocalizations {
  ...
  /// No description provided for @hospitalName5.
  ///
  /// In en, this message translates to:
  /// **'Apex Medical Hub'**
  String get hospitalName5;

  /// No description provided for @hospitalName6.
  ///
  /// In en, this message translates to:
  /// **'Zenith Health Campus'**
  String get hospitalName6;
  ...
  /// Doctor bio with placeholders
  ///
  /// In en, this message translates to:
  /// **'Dr. {name} is an experienced {speciality} specialist at {hospital}. Combining medical expertise with a warm, approachable personality, they bring kindness, experience, and dedication to every visit.'**
